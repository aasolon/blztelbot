...
CREATE TABLE CIV_PLAYER (
    ID                  UUID            NOT NULL CONSTRAINT PK_CIV_PLAYERS PRIMARY KEY,
    VERSION             BIGINT          NOT NULL DEFAULT 0,
    CIV_NAME            VARCHAR(4000)   NOT NULL CONSTRAINT UK_CIV_PLAYERS_CIV_NAME UNIQUE,
    TELEGRAM_NAME       VARCHAR(4000)   NOT NULL,
    TELEGRAM_ID         BIGINT          NOT NULL CONSTRAINT UK_CIV_PLAYERS_TELEGRAM_ID UNIQUE
);